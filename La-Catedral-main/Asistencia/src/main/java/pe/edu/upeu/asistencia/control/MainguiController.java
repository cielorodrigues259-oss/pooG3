...
public class MainguiController {
    ...
    @FXML
    private MenuItem menuItem2, menuItemS, menuItem3;
    @Autowired
    private ApplicationContext context;

    @FXML
    private TextField txtUsuario; // Added
    @Autowired
    private UsuarioRepository usuarioRepository; // Added
    ...
    @FXML
    private void handleEmpleadoButton(ActionEvent event) {
        loadView("/fxml/main_empleado.fxml");
    }

    @FXML
    private void handleAdministradorButton(ActionEvent event) {
        loadView("/fxml/main_producto.fxml"); // Using main_producto.fxml as a placeholder for now
    }
    ...
    class MenuItemListener{
        Map<String, String[]> menuConfig = Map.of(
                "menuItem2", new String[]{"/fxml/main_empleado.fxml", "Empleados","T"},
                "menuItem3", new String[]{"/fxml/main_producto.fxml", "Productos","T"},
